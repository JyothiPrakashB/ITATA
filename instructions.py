class InstructionsHandler:
    ...
    def load_instruction_set3(self, ):
        ...
        output: features, iChat, Photobooth, garage band
        Positive example 3-
        input: The screen resolution is stunningly clear and vibrant.
        output: screen resolution
        Positive example 4-
        input: Its lightweight design makes it incredibly portable for travel.
        output: lightweight design, portability
        Positive example 5-
        input: I love the fast processing speed; applications load almost instantly.
        ...
        output: keyboard
        Negative example 3-
        input: The fan noise is quite loud and distracting during quiet moments.
        output: fan noise
        Negative example 4-
        input: Unfortunately, the webcam quality is grainy and poor in low light.
        output: webcam quality
        Negative example 5-
        input: The limited storage space became a problem very quickly.
        ...
        output: virus scan
        Neutral example 3-
        input: The device includes a standard USB-C port for charging and data transfer.
        output: USB-C port
        Neutral example 4-
        input: It comes pre-installed with the latest operating system version.
        output: operating system version
        Neutral example 5-
        input: The manual mentions the processor specifications and RAM capacity.
        output: processor specifications, RAM capacity
        Now complete the following example-
        input: """
        ...
        output: food, menu, service, setting
        Positive example 3-
        input: The ambiance was cozy and perfect for a date night.
        output: ambiance
        Positive example 4-
        input: We were impressed by the attentive staff and the quick service.
        output: staff, service
        Positive example 5-
        input: Their pasta dishes are authentic and absolutely delicious.
        output: pasta dishes
        Negative example 1-
        input: They did not have mayonnaise, forgot our toast, left out ingredients (ie cheese in an omelet), below hot temperatures and the bacon was so over cooked it crumbled on the plate when you touched it.
        output: toast, mayonnaise, bacon, ingredients, plate
        ...
        output: seats
        Negative example 3-
        input: The music was way too loud, making conversation difficult.
        output: music
        Negative example 4-
        input: My soup arrived cold, and the bread felt stale.
        output: soup, bread
        Negative example 5-
        input: Finding parking near the restaurant was a real nightmare.
        output: parking
        Neutral example 1-
        input: I asked for seltzer with lime, no ice.
        output: seltzer with lime
        ...
        output: glass of wine
        Neutral example 3-
        input: The restaurant is located on the corner of Main Street.
        output: location
        Neutral example 4-
        input: The menu listed several vegetarian options.
        output: menu, vegetarian options
        Neutral example 5-
        input: We made a reservation for four people at 7 PM.
        output: reservation
        Now complete the following example-
        input: """
        self.ate['delim_instruct'] = ''
        ...
        output: positive
        Positive example 3-
        input: The screen resolution is stunningly clear and vibrant. The aspect is screen resolution.
        output: positive
        Positive example 4-
        input: Its lightweight design makes it incredibly portable for travel. The aspect is lightweight design.
        output: positive
        Positive example 5-
        input: I love the fast processing speed; applications load almost instantly. The aspect is processing speed.
        output: positive
        Negative example 1-
        input: Speaking of the browser, it too has problems. The aspect is browser.
        output: negative
        ...
        output: negative
        Negative example 3-
        input: The fan noise is quite loud and distracting during quiet moments. The aspect is fan noise.
        output: negative
        Negative example 4-
        input: Unfortunately, the webcam quality is grainy and poor in low light. The aspect is webcam quality.
        output: negative
        Negative example 5-
        input: The limited storage space became a problem very quickly. The aspect is storage space.
        output: negative
        Neutral example 1-
        input: I took it back for an Asus and same thing- blue screen which required me to remove the battery to reset. The aspect is battery.
        output: neutral
        ...
        output: neutral
        Neutral example 3-
        input: The device includes a standard USB-C port for charging and data transfer. The aspect is USB-C port.
        output: neutral
        Neutral example 4-
        input: It comes pre-installed with the latest operating system version. The aspect is operating system version.
        output: neutral
        Neutral example 5-
        input: The manual mentions the processor specifications and RAM capacity. The aspect is processor specifications.
        output: neutral
        Now complete the following example-
        input: """
        ...
        output: positive
        Positive example 3-
        input: The ambiance was cozy and perfect for a date night. The aspect is ambiance.
        output: positive
        Positive example 4-
        input: We were impressed by the attentive staff and the quick service. The aspect is staff.
        output: positive
        Positive example 5-
        input: Their pasta dishes are authentic and absolutely delicious. The aspect is pasta dishes.
        output: positive
        Negative example 1-
        input: They did not have mayonnaise, forgot our toast, left out ingredients (ie cheese in an omelet), below hot temperatures and the bacon was so over cooked it crumbled on the plate when you touched it. The aspect is toast.
        output: negative
        ...
        output: negative
        Negative example 3-
        input: The music was way too loud, making conversation difficult. The aspect is music.
        output: negative
        Negative example 4-
        input: My soup arrived cold, and the bread felt stale. The aspect is soup.
        output: negative
        Negative example 5-
        input: Finding parking near the restaurant was a real nightmare. The aspect is parking.
        output: negative
        Neutral example 1-
        input: I asked for seltzer with lime, no ice. The aspect is seltzer with lime.
        output: neutral
        ...
        Now complete the following example-
        Neutral example 3-
        input: The restaurant is located on the corner of Main Street. The aspect is location.
        output: neutral
        Neutral example 4-
        input: The menu listed several vegetarian options. The aspect is vegetarian options.
        output: neutral
        Neutral example 5-
        input: We made a reservation for four people at 7 PM. The aspect is reservation.
        output: neutral
        input: """
        self.atsc['delim_instruct'] = ' The aspect is '
        self.atsc['eos_instruct'] = '.\noutput:'
        ...
        Positive example 3-
        input: The screen resolution is stunningly clear and vibrant.
        output: screen resolution:positive
        Positive example 4-
        input: Its lightweight design makes it incredibly portable for travel.
        output: lightweight design:positive, portability:positive
        Positive example 5-
        input: I love the fast processing speed; applications load almost instantly.
        output: processing speed:positive
        Negative example 1-
        input: Speaking of the browser, it too has problems.
        output: browser:negative
        Negative example 2-
        ...
        Negative example 3-
        input: The fan noise is quite loud and distracting during quiet moments.
        output: fan noise:negative
        Negative example 4-
        input: Unfortunately, the webcam quality is grainy and poor in low light.
        output: webcam quality:negative
        Negative example 5-
        input: The limited storage space became a problem very quickly.
        output: storage space:negative
        Neutral example 1-
        input: I took it back for an Asus and same thing- blue screen which required me to remove the battery to reset.
        output: battery:neutral
        Neutral example 2-
        ...
        Neutral example 3-
        input: The device includes a standard USB-C port for charging and data transfer.
        output: USB-C port:neutral
        Neutral example 4-
        input: It comes pre-installed with the latest operating system version.
        output: operating system version:neutral
        Neutral example 5-
        input: The manual mentions the processor specifications and RAM capacity.
        output: processor specifications:neutral, RAM capacity:neutral
        Now complete the following example-
        input: """
        ...
        Positive example 4-
        input: We were impressed by the attentive staff and the quick service.
        output: staff:positive, service:positive
        Positive example 5-
        input: Their pasta dishes are authentic and absolutely delicious.
        output: pasta dishes:positive
        Negative example 1-
        input: They did not have mayonnaise, forgot our toast, left out ingredients (ie cheese in an omelet), below hot temperatures and the bacon was so over cooked it crumbled on the plate when you touched it.
        output: toast:negative, mayonnaise:negative, bacon:negative, ingredients:negative, plate:negative
        Negative example 2-
        ...
        Negative example 3-
        input: The music was way too loud, making conversation difficult.
        output: music:negative
        Negative example 4-
        input: My soup arrived cold, and the bread felt stale.
        output: soup:negative, bread:negative
        Negative example 5-
        input: Finding parking near the restaurant was a real nightmare.
        output: parking:negative
        Neutral example 1-
        input: I asked for seltzer with lime, no ice.
        output: seltzer with lime:neutral
        Neutral example 2-
        ...
        Neutral example 3-
        input: The restaurant is located on the corner of Main Street.
        output: location:neutral
        Neutral example 4-
        input: The menu listed several vegetarian options.
        output: menu:neutral, vegetarian options:neutral
        Neutral example 5-
        input: We made a reservation for four people at 7 PM.
        output: reservation:neutral
        Now complete the following example-
        input: """
        self.aspe['delim_instruct'] = ''
        self.aspe['eos_instruct'] = ' \noutput:'